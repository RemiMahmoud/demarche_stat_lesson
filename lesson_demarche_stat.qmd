...
-   La visualisation dépend:
    ...
    -  [le site data-to-viz.com](data-to-viz.com){style="color:blue;"} permet de trouver de bonnes idées
...
\vfill
```
\bf Décision : \\\\\\\$\\\\\\\\mathbb{P}({\\\\\\\\mathcal F}\\\\\\\_{ddl\\\\\\\_{\\\\\\\\mathcal V}}\\\\\\\^{ddl_R}\\\\\\\>F\\\\\\\_{obs}) \\\\\\\< 0.05\\\\\\\~\\\\\\\~\\\\\\\\Longrightarrow\\\\\\\$ Rejet de \\\\\\\$H_0\\\\\\\$
